...
/// This funciton takes the name of a file containing a private ECDSA
...
/// This function takes the name of a file contianing a public ECDSA key,
/// the name of a file storing a signature for a vector of
