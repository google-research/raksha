...
class AccessPathSelectorsSet {
 public:
  ...
  static AccessPathSelectorsSet Intersect(AccessPathSelectorsSet set1,
    ...
    common::containers::HashSet<AccessPathSelectors> hash_set1 =
  ...
  // common::containers::HashSet. This uniques and provides access to the contents of
  // this "set".
  static common::containers::HashSet<AccessPathSelectors> CreateAbslSet(
      AccessPathSelectorsSet original_set) {
    return common::containers::HashSet<AccessPathSelectors>(
