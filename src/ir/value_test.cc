...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        std::make_pair(Value(test_data.first_block_first_arg), "one"),
        std::make_pair(Value(test_data.first_block_second_arg), "two"),
        std::make_pair(Value(test_data.second_block_first_arg), "one"),
        std::make_pair(Value(test_data.second_block_second_arg), "two"),
        std::make_pair(Value(test_data.plus_operation_result1), "res1"),
        std::make_pair(Value(test_data.plus_operation_result2), "res2"),
        std::make_pair(Value(test_data.minus_operation_result1), "res1"),
        std::make_pair(Value(test_data.minus_operation_result2), "res2"),
