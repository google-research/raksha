...
TEST_P(CreateAbslSetTest, CreateAbslSetTest) {
  ...
  ASSERT_EQ(
      ...
      common::containers::HashSet<AccessPathSelectors>(param.begin(), param.end()));
}
...
TEST_P(AddParentTest, AddParentTest) {
  ...
  common::containers::HashSet<AccessPathSelectors> absl_original_set =
  ...
  common::containers::HashSet<AccessPathSelectors> absl_set_with_parent =
  ...
  common::containers::HashSet<std::string> set_with_parent_strings;
...
absl::btree_set<std::string> MakeOrderedStrSet(
  ...
  common::containers::HashSet<AccessPathSelectors> absl_hash_set =
