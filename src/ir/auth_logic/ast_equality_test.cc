...
class PrincipalEqTest
    : public testing::TestWithParam<
          std::tuple<std::pair<Principal, uint64_t>,
            std::pair<Principal, uint64_t>>> {
};
...
static std::pair<Principal, uint64_t> principalTestVals[] = {
  {prinA, 0},
  {prinB, 1}
};

INSTANTIATE_TEST_SUITE_P(PrincipalEqTest, PrincipalEqTest,
  testing::Combine(testing::ValuesIn(principalTestVals),
    testing::ValuesIn(principalTestVals)));

class AttributeEqTest
    : public testing::TestWithParam<
          std::tuple<std::pair<Attribute, uint64_t>,
          std::pair<Attribute, uint64_t>>> {
};
...
class BaseFactEqTest
    : public testing::TestWithParam<
          std::tuple<std::pair<BaseFact, uint64_t>,
...
class FactEqTest
    : public testing::TestWithParam<
          std::tuple<std::pair<Fact, uint64_t>,
          std::pair<Fact, uint64_t>>> {
};
...
class AssertionEqTest
    : public testing::TestWithParam<
          std::tuple<std::pair<Assertion, uint64_t>,
          std::pair<Assertion, uint64_t>>> {
};
...
class QueryEqTest
    : public testing::TestWithParam<
          std::tuple<std::pair<Query, uint64_t>,
          std::pair<Query, uint64_t>>> {
};
...
class ProgramEqTest
    : public testing::TestWithParam<
          std::tuple<std::pair<Program, uint64_t>,
...
static Program program3({relationDeclaration1}, {saysAssertion1}, {query1, query1});
