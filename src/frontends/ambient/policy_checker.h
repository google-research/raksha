...
class PolicyChecker {
 public:
  ...
  absl_shim::flat_hash_set<PolicyChecker::Settings> AvailableSettings(
      User user) const;
 ...
 private:
  ...
  // Returns the set of available settings for the given user.
  absl_shim::flat_hash_set<std::string> AvailableSettings(
  ...
  absl_shim::flat_hash_set<DataFlowEdge> edges_;
