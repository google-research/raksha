...
#ifndef SRC_FRONTENDS_ARCS_XFORM_TO_DATALOG_DATALOG_FACTS_H_
#define SRC_FRONTENDS_ARCS_XFORM_TO_DATALOG_DATALOG_FACTS_H_
...
class DatalogFacts {
 public:
  ...
  std::string ToDatalog(frontends::arcs::DatalogPrintContext &ctxt) const {
    return absl::StrFormat(kDatalogFileFormat,
