...
#ifndef SRC_FRONTENDS_ARCS_TAG_CHECK_H_
#define SRC_FRONTENDS_ARCS_TAG_CHECK_H_
 ...
 public:
  ...
  bool operator==(const TagCheck &other) const {
    return (access_path_ == other.access_path_) &&
           // If the two predicates are pointer equal, they are necessarily
           // equal. If they are not pointer equal, they may still be equal if
           // they are fully structurally equal.
...
#endif  // SRC_FRONTENDS_ARCS_TAG_CHECK_H_
