...
enum AccessPathRootKind { kHandleConnectionSpec, kHandleConnection, kHandle };
...
static AccessPathRootTypeAndArgs root_and_info_array[] = {
    ...
    {.root = AccessPathRoot(
         HandleConnectionAccessPathRoot("recipe2", "particle", "handle")),
     .kind = kHandleConnection,
     .arg_strings = {"recipe2", "particle", "handle"}},
    {.root = AccessPathRoot(
         HandleConnectionAccessPathRoot("recipe", "particle2", "handle")),
     .kind = kHandleConnection,
     .arg_strings = {"recipe", "particle2", "handle"}},
    {.root = AccessPathRoot(
         HandleConnectionAccessPathRoot("recipe", "particle", "handle2")),
     .kind = kHandleConnection,
