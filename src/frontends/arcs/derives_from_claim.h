...
#ifndef SRC_FRONTENDS_ARCS_DERIVES_FROM_CLAIM_H_
#define SRC_FRONTENDS_ARCS_DERIVES_FROM_CLAIM_H_
...
class DerivesFromClaim {
 public:
  ...
  Edge GetAsEdge() const { return Edge(source_, target_); }
...
#endif  // SRC_FRONTENDS_ARCS_DERIVES_FROM_CLAIM_H_
